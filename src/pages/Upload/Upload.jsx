    ...
    return (
        <Box sx={{display: 'flex', alignItems: 'center', flexDirection: 'column', marginTop: '100px'}}>
            ...
            <Box sx={{display: 'flex', alignItems: 'center', gap: '30px'}}>
                {!file ? (
                    <Box onDragEnter={handleDrag} onDragOver={handleDrag} onDragLeave={handleLeave} onDrop={handleDrop}
                         sx={{
                             width: '40%',
                             minHeight: '65vh',
                        ...
                        <Box sx={{
                            ...
                            <FileUploadOutlinedIcon sx={{width: '50px', height: '50px', color: '#a4a4a4', marginTop: '5vh'}}/>
                            <p style={{marginTop: '1%'}}>Выберите или перетащите видео для загрузки</p>
                            <Box sx={{display: 'flex', flexDirection: 'column', alignItems: 'center', color: '#a4a4a4', fontSize: '12px', marginTop: '5vh'}}>
                    ...
                    <Box sx={{position: 'relative'}}>
                        <Video url={imageUrl}/>
                        <DeleteIcon onClick={handleDeleteVideo} sx={{
                            position: 'absolute',
                            top: '16px',
                            right: '16px',
                            cursor: 'pointer',
